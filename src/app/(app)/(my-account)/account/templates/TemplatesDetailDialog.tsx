...
interface AddTemplateDialogProps {
  ...
  template: {
    ...
    projects_using?: number; // Add this field
    total_files?: number;
  };
...
const TemplatesDetailDialog = ({
  ...
  const renderProgressOrTitle = ({
    ...
    } else if (showProgressBar > 0 && showProgressBar < 100) {
      return (
        <Progressbar
          labelClassName="text-black dark:text-white"
      ...
      <FormProvider {...methods}>
        <div className="flex justify-end">
          <Dialog open={!!isOpen} onOpenChange={onOpenChange}>
            ...
            <DialogContent className="fixed p-6 bg-secondaryBackground rounded-md shadow-lg top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:w-100 element sm:max-w-[100%] md:max-w-[50rem] max-w-[100%]">
              <div
                style={{ display: "flex" }}
                ...
                <div className="flex gap-4 flex-col md:flex-row w-full">
                  ...
                  >
                    <div className="grid gap-2 relative">
                      <Label htmlFor="name">Enter Template name</Label>
                      <Tooltip>
                    ...
                    <div>
                      {isOpen === "edit_template" ? (
                        <>
                          <div className="grid gap-2 relative">
                            <Label htmlFor="templates" className="pt-3">
                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <Textarea
                                  id="templates"
                                  placeholder="Enter why this template is useful."
                                  {...register("templates")}
                                />
                              </TooltipTrigger>
                              {errors.templates && (
                              ...
                              <div className="inline-flex items-center py-1">
                                <label className="relative flex items-center cursor-pointer">
                                  <input
                                    ...
                                    id="html"
                                  />
                                  <span className="absolute bg-slate-800 dark:bg-[#ffffff] w-3 h-3 rounded-full opacity-0 peer-checked:opacity-100 transition-opacity duration-200 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></span>
                                </label>
                                <label className="not-italic block text-sm font-medium text-gray-900 dark:text-white">
                                  {" "}
...
export default TemplatesDetailDialog;
