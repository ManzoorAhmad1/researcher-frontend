...
interface scamperDataType {
  ...
  interface SwipeableCardsDialogProps {
    ...
    scamperDataId: number | undefined;
  }
  ...
  interface DataType {
    id: number;
    created_at: string; // You might want to consider using Date type depending on your use case
    keyword_type: string;
    user_id: number;
    keyword_name: string;
  ...
  export {scamperDataType,SwipeableCardsProps,CardProps,DataType,ScamperCardsProps,HistoryDialogProps,ScamperItem,SingleSwipeableCardProps,SwipeableCardsDialogProps}