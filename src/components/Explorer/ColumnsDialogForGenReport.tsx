...
const DraggableColumnForGenReport: React.FC<ColumnsDialogProps> = ({
  ...
  const [moveLabel, setMoveLabel] = useState(tableColumnsOptions);
  const [isHideShowOpen, setIsHideShowOpen] = useState(true);
...
export default DraggableColumnForGenReport;
