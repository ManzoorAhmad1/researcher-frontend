...
const paginationStyles = {
  ...
  variant: {
    solid: {
      ...
      color: {
        primary:
          "[&>.rc-pagination-item-active]:bg-[#0E70FF] [&>.rc-pagination-item-active>a]:!text-primary-foreground [&>li.rc-pagination-item-active]:border-primary [&>.rc-pagination-item-active]:hover:border-primary [&>.rc-pagination-item-active]:focus:border-primary",
        secondary:
